			...
			<div class="navbar-collapse w-100 collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll me-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle active" href="#" id="demoMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Information</a>
						<ul class="dropdown-menu" aria-labelledby="demoMenu">
							...
							<li> <a class="dropdown-item" href="/unvisersity">University</a></li>
							<li> <a class="dropdown-item" href="kingergarten">Kindergarten</a></li>
							<li> <a class="dropdown-item" href="/landing">Landing</a></li>
