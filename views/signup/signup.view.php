			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-12 col-lg-6 m-auto ">
						<div class="row my-3">
							<div class="mt-3 col-sm-12 col-xl-12 m-auto border shadow-lg p-3 mb-5 rounded bordered"">
								<!-- Title -->
								<p class="fs-2 text-center" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">Create account here!</p>
								<!-- Form START -->
