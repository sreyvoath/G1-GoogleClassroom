...
<main>
    ...
    <form action="controllers/score/return_score.controller.php" method="post">
        ...
        <div class="contain d-flex" style="width: 100%; margin-top: -40px;">
            <div class="tag"></div>
            <div class="container mycontainer mt-5" style="width: 50%; ">
                <div class="row p-3 mt-5 myrow  custom-row " id="containers">
                    <div class="col-md-9 pe-0  " style="width: 100%;">
                        <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0" id="containerse">
                            <div class="left " style="width: 100%; border-right: 1px solid LightGray;">
            ...
            <div class="container mycontainer mt-5 " style="width: 100%; ">
                <div class="row p-3 mt-5 myrow  custom-row  " id="containers" style="width: 100%;">
                    <div class="col-md-9 pe-0 " style="width: 100%; margin-top: 30px;" >
