				...
				<div>
					<div class="mb-3 d-sm-flex justify-content-sm-between align-items-center">
						...
						<div>
							...
							<span class="me-3 small">June 18, 2024 at 11:55 AM</span>
						</div>
						<!-- Review star -->
						<ul class="list-inline mb-0">
				...
				<div>
					<div class="mb-3 d-sm-flex justify-content-sm-between align-items-center">
						...
						<div>
							...
							<span class="me-3 small">August 28, 2024 at 3:08 PM</span>
						</div>
						<!-- Review star -->
						<ul class="list-inline mb-0">
							<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
				...
				<div>
					<div class="mb-3 d-sm-flex justify-content-sm-between align-items-center">
						...
						<div>
							...
							<span class="me-3 small">August 29, 2024 at 5:35 PM</span>
						</div>
						<!-- Review star -->
						<ul class="list-inline mb-0">
							<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
			...
			<div class="d-sm-flex">
				...
				<div>
					<div class="mb-3 d-sm-flex justify-content-sm-between align-items-center">
						...
						<div>
							<h5 class="m-0">Carolyn Ortiz</h5>
							<span class="me-3 small">September 15, 2024 at 8:28 AM</span>
						</div>
						<!-- Review star -->
						<ul class="list-inline mb-0">
							<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
