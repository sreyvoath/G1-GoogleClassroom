...
<main>
    ...
    <!-- Search bar -->
    <script src="../../js/main.js"></script>
    <div class="containers  d-flex" style="width: 100%;">
        <form action="controllers/score/return_score.controller.php" method="post" >
            ...
            <div class="contain d-flex " style="width: 100%;  margin-top: 80px;" >
                <div class="contain d-flex " style="width: 100%; margin-top: 19px;">
                    <div class="tag"></div>
                    <div class="row myrow custom-row " id="containers" style="width: 100%;">
