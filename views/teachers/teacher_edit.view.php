...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col-2"></div>
            <div class="col-8 d-flex gap-5 border border-info border-3 p-5 shadow-lg p-3 mb-5 bg-body rounded" style="border-radius: 30px;">
                <div class="image p-1">
                ...
                <form method="POST" action="../../controllers/teachers/teacher_update.controller.php" enctype="multipart/form-data" class="" style="width:100%; height:auto">
