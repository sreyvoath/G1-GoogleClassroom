...
<body>
    <div class="container mt-3">
        <div class="row bg-body shadow p-2" style="width:auto; height:100%;">
            <div class="col-12">
                <div class=" nav-menu d-flex p-3" style="width:100%; height:100%;">
            ...
            <hr>
            <div class="class">
                <button class="d-flex justify-content-between align-items-center bg-purple text-white btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="width:150px; height:40px;border:none;margin:10px 0 30px 60px ;">
            ...
            <!-- list-assignment -->
            <div class="dropdown-submenu dropend shadow-sm mb-3 bg-body rounded px-4 py-2 d-flex justify-content-between border-start border-5 border-primary" style="width:90%; margin:auto;">
